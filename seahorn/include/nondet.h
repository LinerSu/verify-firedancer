...
extern NONDET_FN_ATTR long nd_long(void);
extern NONDET_FN_ATTR unsigned char nd_uchar(void);
extern NONDET_FN_ATTR unsigned long nd_ulong(void);
extern NONDET_FN_ATTR unsigned int nd_uint(void);
